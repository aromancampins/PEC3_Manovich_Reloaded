...
Mientras que, en un entorno multimedia convencional, el texto, los planos y las imágenes aéreas trabajan juntas, pero conviviendo en medios separados, el gemelo digital los unifica en una interfaz 3D en la cual cada capa deja de ser independiente de las demás: la fotografía aérea se visualiza mediante modelos 3D, la cartografía se convierte en geometría, y los datos demográficos se visualizan como flujos dinámicos, de manera similar a cómo Google Earth mezcla fotografía, cartografía y modelos 3D para producir una experiencia de navegación unificada.
...
En el rol de mesa clásico, el “software” de simulación es el propio grupo de jugadores: el director de juego (que también se considera jugador) interpreta las reglas, describe el mundo al resto de jugadores y arbitra las consecuencias de las acciones que se van aconteciendo mediante dados, hojas con las características de cada personaje y mapas físicos donde desarrollar la historia. Baldur’s Gate III convierte esa lógica en un sistema de software que combina un motor 3D, un sistema de reglas programadas, interfaces de diálogo ramificado, IA de NPCs y gestión de estados, produciendo una experiencia jugable donde cada elección se traduce en múltiples posibles desenlaces, hasta el punto de que se habla de miles de variantes de finales. El resultado es una versión del juego de mesa que no copia literalmente sus partidas, sino que explora el espacio de posibilidades que las reglas permiten.

Desde el punto de vista del software, Baldur’s Gate III hace visible la distinción entre técnicas específicas e independientes del medio que describe Manovich. Los sistemas de animación, efectos visuales o simulación física de cuerpos y proyectiles son técnicas específicas del medio audiovisual interactivo, que no existen en el juego de mesa. No obstante, operaciones genéricas como ordenar, buscar, filtrar estados, registrar elecciones, ramificar diálogos o sincronizar eventos funcionan como técnicas independientes del medio que se aplican tanto a texto como a audio, animación o lógica de juego, sosteniendo la promesa de libertad narrativa que el juego hereda del rol de mesa.
